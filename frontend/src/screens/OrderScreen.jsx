...
const OrderScreen = ({ match, history }) => {
    ...
    return loading ? <Loader /> : error ? <Message variant='red'>{error}</Message> : <>
       <h3>Order ID: {(order._id).slice(0,10)}</h3>
       <Row>
            <Col md={8}>
                       ...
                       <p> <strong> Address: </strong>  
                           ...
                           {order.shippingAddress.postalCode}, {order.shippingAddress.country}
                            ...
                            {order.isDelivered ? <Message variant='success'>
                                Delivered on {(order.deliveredAt.slice(0,10))}</Message> : 
                    ...
                    <ListGroup.Item>
                        <h3>Payment Method</h3>
                            ...
                            {order.isPaid ? <Message variant='success'>
                                Paid on {(order.paidAt.slice(0,10))}</Message> : 
